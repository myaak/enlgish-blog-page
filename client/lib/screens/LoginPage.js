...
var LoginPage = function () {
    ...
    return (<div className="login">
      <div className="login__wrapper">
        <formik_1.Formik initialValues={{ email: '', password: '' }} validationSchema={Yup.object({
            email: Yup.string()
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch('http://193.201.88.172:7000/auth/login', {
                                method: "POST",
                                credentials: 'include',
                                headers: {
          ...
          {function (_a) {
            ...
            return (<form onSubmit={handleSubmit}>
              ...
              <div style={{
                ...
                <react_2.Button colorScheme={'blue'} type="button">Forgot password?</react_2.Button>
                <react_2.Button colorScheme={'blue'} type="button" onClick={handleSignUpRedirect}>Register</react_2.Button>
              </div>
              <react_2.Button type="submit" variant="contained">Log In</react_2.Button>
            </form>);
        }}
        </formik_1.Formik>
      </div>
